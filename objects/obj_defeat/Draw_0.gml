...
if (cus=false){
    ...
    if (global.icon<=22) then scr_image("creation/chapters/icons",global.icon,728,83,135,135);
    if (global.icon>22) then draw_sprite_stretched(spr_icon_chapters,global.icon-21,728,83,135,135);
}
// 728,103
