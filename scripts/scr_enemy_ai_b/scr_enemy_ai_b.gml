function scr_enemy_ai_b() {
    ...
    for (i = 1; i <= planets; i++) {
        ...
        if ((p_owner[i] == 7) && (p_orks[i] < 5) && (p_traitors[i] == 0) && (p_player[i] <= 0 || !is_garrison_force)) {
            if ((p_orks[i] > 0) && (p_orks[i] < 5) && (ork_growth <= 15)) {
                if (sabotage_force) {
                    if (irandom(3) < 2) {
        ...
        if ((p_population[i] < p_max_population[i]) && (p_type[i] != "Dead") && (p_type[i] != "Craftworld") && (p_owner[i] <= 5) && (p_traitors[i] == 0) && (p_tau[i] == 0) && (p_orks[i] == 0) && (p_necrons[i] == 0) && (p_tyranids[i] == 0)) {
            if (p_large[i] == 0) {
        ...
        if (array_length(p_feature[i]) != 0) {
            ...
            if (has_awake_tomb) {
                ...
                if ((p_population[i] > 0) && (p_player[i] + p_pdf[i] + p_guardsmen[i] + p_tyranids[i] == 0)) {
                    p_population[i] = p_population[i] * 0.75;
                    if ((p_large[i] == 0) && (p_population[i] <= 5000)) {
                        p_population[i] = 0;
                    }
                }
        ...
        if ((p_owner[i] != eFACTION.Chaos) && (p_owner[i] != eFACTION.Heretics) && (p_owner[i] != eFACTION.Eldar) && (planets >= i) && (p_type[i] != "Dead") && (p_type[i] != "Craftworld")) {
            ...
            if (!is_ork) {
                ...
                if (rando < score_to_beat) {
                    success = true;
                }
            }

            if (success && (p_pdf[i] == 0) && (p_guardsmen[i] == 0) && (p_tau[i] == 0) && (p_orks[i] == 0)) {
                p_owner[i] = 10;
            ...
            if (success && (p_type[i] != "Space Hulk")) {
                ...
                if (rando <= 40) {
                    ...
                    if (garrison_mod > 0) {
                        ...
                        if (p_traitors[i] == 0) {
                            if (p_pdf[i] > 0) {
                                tixt = $"{scr_display_number(lost)} PDF killed in a rebellion on {planet_string}.";
                            } else if (p_pdf[i] == 0) {
                ...
                } else if ((rando >= 41) && (rando < 81) && (p_traitors[i] < 2)) {
                    if (is_garrison_force) {
                    ...
                    tixt = $"Heretic cults have appeared in {planet_string}.";
                } else if ((rando >= 81) && (rando < 91) && (p_traitors[i] < 3)) {
                    // Minor uprising
                    if (is_garrison_force) {
                ...
                if ((rando >= 91) && (rando < 100) && (p_traitors[i] < 4)) {
                    notixt = true;
                    p_traitors[i] = 4;
        ...
        if ((p_type[i] != "Space Hulk") && (p_type[i] != "Dead")) {
            if ((p_heresy[i] < 70) && (owner == 10)) {
                p_heresy[i] += 2;
            }
            if ((p_heresy[i] < 70) && (owner == 8)) {
                var doggy = floor(random(100)) + 1;
                if ((doggy <= 5) && (p_heresy[i] >= 20)) {
                    p_heresy[i] += 1;
                }
            }
        }

        if ((p_type[i] == "Daemon") && (p_type[i] != "Space Hulk")) {
            if (p_pdf[i] > 0) {
                p_pdf[i] = 0;
            }
            if (p_guardsmen[i] > 0) {
        ...
        for (i = 1; i <= planets; i++) {
            ...
            if ((i <= planets) && (tau_influence >= 70) && (p_owner[i] != 8) && (p_owner[i] != 10) && (p_owner[i] != 7) && (p_owner[i] != 9) && (p_type[i] != "Space Hulk")) {
                ...
                if ((tau_chance >= 95) && (p_orks[i] == 0) && (p_traitors[i] == 0) && (p_necrons[i] == 0) && (p_demons[i] == 0) && (p_chaos[i] == 0)) {
                    ...
                    if (badd == 1) {
                        scr_alert("red", "owner", "Planet " + planet_string + " has seceded, joining the Tau Empire!", x, y);
                        if (visited == 1) {
